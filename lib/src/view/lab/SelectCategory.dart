...
import 'package:biacoo/src/view/lab/SelectCategoryMoreDetails.dart';
import 'package:biacoo/src/view/pharmacy/VerifyOrder.dart';
import 'package:flutter/material.dart';
class SelectCategory extends StatefulWidget {
  @override
  SelectCategoryState createState() => new SelectCategoryState();
}
          ...
          child:Column(
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: Text("Select Categories",style: TextStyle(fontSize:2.5*SizeConfig.textMultiplier!,color: Color(0xff6D6B6B),fontFamily: "OpenSans"),textAlign: TextAlign.center,),
                ),
                  ...
                  child: Container(
                    ...
                    child: TextButton(
                      ...
                      onPressed: () {
                        Navigator.of(context).pushReplacement(
                          MaterialPageRoute( builder: (BuildContext context){
                            return SelectCategoryMoreDetail();
                          },),
                        );
                      },
                    ),
...
class CheckBoxListTileModel {
  ...
  CheckBoxListTileModel({this.categoryId, this.img, this.title, String? des, this.isCheck});

  static List<CheckBoxListTileModel> getCategoryList() {
    return <CheckBoxListTileModel>[
      CheckBoxListTileModel(
          categoryId: 1,
          img: Images.CardiovascularIcon,
      ...
      CheckBoxListTileModel(
          categoryId: 3,
          img: Images.EndocrineIcon,
          title: "Endocrine",
          des:"FNA | CT | MRI | PET | RAI | MIBG",
          isCheck: true),
      CheckBoxListTileModel(
          categoryId: 4,
          img: Images.GastrointestinalIcon,
