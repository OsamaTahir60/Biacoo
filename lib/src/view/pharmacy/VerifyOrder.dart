            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  Align(
                      ...
                      child: Padding(
                        padding: EdgeInsets.all(0.5*SizeConfig.heightMultiplier!),
                        child: Text("Verify Your Order",style: TextStyle(fontSize:2.5*SizeConfig.textMultiplier!,color: Color(0xff6D6B6B),fontFamily: "OpenSans"),textAlign: TextAlign.center,),
                      )
                  ),
                  Align(
                      alignment: Alignment.topLeft,
              ...
              Container(
                ...
                child: Row(
                  ...
                  children: [
                    Text("Sub Total(2 Items): ",style: TextStyle(fontSize: 2.1*SizeConfig.textMultiplier!,color: Colors.black),),
                    Text("Rs: 1000",style: TextStyle(fontSize: 2.1*SizeConfig.textMultiplier!,color: Colors.black),),
                  ],
                ),
              ),
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  child: Row(
                    children: [
                      Text("+",style: TextStyle(fontSize: 3.1*SizeConfig.textMultiplier!,color: Color(0xff6D6B6B)),),
                      SizedBox(width: 2*SizeConfig.widthMultiplier!,),
                      Container(
                        color: Colors.white,
                        child: Text("12",style: TextStyle(fontSize: 2.1*SizeConfig.textMultiplier!,color: Color(0xff6D6B6B)),),
                      ),
                      SizedBox(width: 2*SizeConfig.widthMultiplier!,),
                      Text("-",style: TextStyle(fontSize: 3.1*SizeConfig.textMultiplier!,color: Color(0xff6D6B6B)),),
