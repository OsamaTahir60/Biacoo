...
import 'package:biacoo/src/view/pharmacy/AddMedicine.dart';
import 'package:biacoo/src/view/pharmacy/UploadPrescription.dart';
...
class PharmacyMainScreen extends StatefulWidget {
  ...
  @override
  _PharmacyMainScreenState createState() => _PharmacyMainScreenState();
}
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Text('Welcome to our ONLINE PHARMACY',style: TextStyle(
