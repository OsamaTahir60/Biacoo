...
class VendorHomeFragment extends StatefulWidget {
  const VendorHomeFragment({Key? key}) : super(key: key);

  @override
  _VendorHomeFragmentState createState() => _VendorHomeFragmentState();
}

class _VendorHomeFragmentState extends State<VendorHomeFragment> {
  @override
