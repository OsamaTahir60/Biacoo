...
import 'package:biacoo/src/view/UploadProfileImage.dart';
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  prefixIcon: Container(
                                    ...
                                    child:Text("Name: ",style: TextStyle(fontSize: 2.2*SizeConfig.textMultiplier!, fontFamily: 'OpenSans', fontWeight: FontWeight.w400,),),
                            ...
                            child:  Container(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  prefixIcon: Container(
                                    padding: EdgeInsets.only(top:11.0,bottom:11.0),
                                    child:Text("Phone: ",style: TextStyle(fontSize: 2.2*SizeConfig.textMultiplier!, fontFamily: 'OpenSans', fontWeight: FontWeight.w400,),),
                      ...
                      Align(
                        ...
                        child: Container(
                          ...
                          child: Container(
                            ...
                            child:  Container(
                              //top:0.5*SizeConfig.heightMultiplier
                              padding: EdgeInsets.only(top:0.3*SizeConfig.heightMultiplier!,left: 2.5 * SizeConfig.heightMultiplier!,right: 1.5 * SizeConfig.heightMultiplier!),
                              decoration: BoxDecoration(
                                  borderRadius: BorderRadius.all(Radius.circular(15.0)),
                                  color: Colors.white
                              ),
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  prefixIcon: Container(
                                    padding: EdgeInsets.only(top:11.0,bottom:11.0),
                                    child:Text("Address: ",style: TextStyle(fontSize: 2.2*SizeConfig.textMultiplier!, fontFamily: 'OpenSans', fontWeight: FontWeight.w400,),),
